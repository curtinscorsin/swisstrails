...
const reviews: CatalogueReview[] = [
  ...
  {
    id: "spot-kropfenstein-castle",
    tagline: "A medieval rock castle hidden beneath the cliffs of Waltensburg",
    summary: "Kropfenstein is a compact castle ruin built into a natural rock overhang above Waltensburg. The selected official Euli Trail reaches the ruin as part of a signed circuit from Tschuppina and keeps the castle pin separate from the route start.",
    routeLabel: "Euli Trail via Kropfenstein Castle", source: official("Surselva Tourism — Mission WUHUUU / Euli Trail", "https://www.graubuenden.ch/en/tours/mission-wuhuuu-euli-trail?nordic-app=1"),
    difficulty: "moderate", bestSeason: ["spring", "summer", "autumn"], season: "Snow-free conditions; verify the current path status", distanceKm: 8, durationMinutes: 180, ascentM: 225, descentM: 263,
    startName: "Tschuppina, Waltensburg", finish: "Tschuppina, Waltensburg", access: "Follow the official circuit from Tschuppina. A shorter official approach is also described from the paid Waltensburg valley-station car park, but it is not the profile shown here.",
    parking: "Use the designated paid parking at the Waltensburg valley station or other signed public parking; do not drive toward the ruin.", publicTransport: "PostBus to Waltensburg/Vuorz, Darums; check the current walking connection to the selected start.", accessibility: "The final signed approach is a narrow natural path beneath a rock overhang and is not step-free.", highlights: ["Kropfenstein rock castle", "Waltensburg forest", "Surselva landscape"], safety: ["The castle approach is narrow and can be slippery when wet; stay on the signed path and supervise children closely.", ...commonSafety], parkingAvailable: true, hasPublicTransport: true,
  },
  {
    id: "spot-lauenensee",
  ...
  {
    id: "spot-hoher-kasten",
    tagline: "A 1,794-metre Alpstein viewpoint above Brülisau",
    summary: "Hoher Kasten stands on the northeastern edge of the Alpstein. The cableway reaches the 1,794-metre summit from Brülisau in about eight minutes; the selected official descent visits Sämtisersee before returning to Brülisau.",
    routeLabel: "Hoher Kasten–Sämtisersee–Ruhesitz–Brülisau", source: official("Hoher Kasten — Lake and Scooter hike", "https://www.hoherkasten.ch/en/explore/activities/hiking/see-und-trottinett/"),
    difficulty: "moderate", bestSeason: ["summer", "autumn"], season: "June–October, subject to current trail and cableway operation", durationMinutes: 195,
    grade: "White-red-white mountain trail, then yellow hiking trail", startName: "Hoher Kasten cableway mountain station", startCoordinates: { lat: 47.283973693847656, lng: 9.484142303466797 }, finish: "Brülisau cableway valley station", access: "Travel to Brülisau and take the Hoher Kasten cableway to the summit. The official itinerary then descends via Sämtisersee, Alp Soll and Ruhesitz to Brülisau.",
    parking: "Use the signed parking serving the Hoher Kasten valley station in Brülisau; check current capacity and charges.", publicTransport: "Use Appenzell Railways to Weissbad and the PostBus to Brülisau; verify the final return connection before departure.", accessibility: "The cableway and summit Europa Trail are described as barrier-free, but the selected mountain descent to Brülisau is not step-free.", feeInfo: "The cableway is ticketed; check current operating times and fares before travel.", highlights: ["Six-country summit panorama", "Europa Trail", "Sämtisersee", "Alpstein and Rhine Valley views"], restrictions: ["Use only open marked trails and respect the cableway's operating times.", "Check the official trail-condition report immediately before departure."], safety: ["The initial descent from Hoher Kasten is steep and the mountain-trail sections require surefootedness.", "Fog, wind, thunderstorms, lingering snow or ice can make this exposed route unsafe.", ...mountainSafety], uncertainties: ["The official route page publishes time and marking but no complete distance, ascent or descent figures; those values remain blank."], parkingAvailable: true, hasPublicTransport: true,
  },
  {
    id: "spot-grindelwald",
    tagline: "An alpine village beneath the Eiger with direct access to First",
    summary: "Grindelwald is the valley village below the Eiger and the transport base for several distinct mountain areas. The selected official outing is the First–Bachalpsee return; its figures do not describe the village pin itself.",
    routeLabel: "First–Bachalpsee return", source: official("Jungfrau Railways — Grindelwald-First and Bachalpsee", "https://www.jungfrau.ch/en-gb/grindelwaldfirst/"),
    difficulty: "moderate", bestSeason: ["summer", "autumn"], season: "During the snow-free First operating season; verify cableway and trail status", durationMinutes: 110,
    startName: "First mountain station", finish: "First mountain station", access: "Travel by rail to Grindelwald, walk or take the local bus to the First gondola, then ride to the official route start at First.",
    parking: "Use signed public parking in Grindelwald and allow for seasonal congestion; rail arrival is the simpler option.", publicTransport: "Rail to Grindelwald, then the signed connection to the First gondola valley station.", accessibility: "Grindelwald village transport and the mountain hiking route have different accessibility; the Bachalpsee trail is not presented here as step-free.", feeInfo: "The First gondola is ticketed; check current fares and operating times.", highlights: ["Eiger north-face setting", "Grindelwald village", "First", "Bachalpsee"], safety: ["Do not confuse the village pin with the First trailhead; mountain weather, snow and gondola operation determine whether the selected route is suitable.", ...mountainSafety], uncertainties: ["The reviewed official page publishes an approximate return time but not a complete distance or elevation profile, so those values remain blank."], parkingAvailable: true, hasPublicTransport: true,
  },
  {
    id: "spot-lac-de-joux",
  ...
  {
    id: "spot-chapf-viewpoint",
    tagline: "A quiet Walensee panorama reached by a short walk from Arvenbüel",
    summary: "Chapf is a 1,288-metre viewpoint above Amden with views across Walensee, Betlis, the Linth plain and the Glarus Alps. The official destination page describes a short approach from Arvenbüel rather than a full hiking-route profile.",
    routeLabel: "Arvenbüel–Chapf viewpoint approach",
    source: official("Amden & Weesen Tourism — Chapf viewpoint", "https://www.amden-weesen.ch/en/poi/detail/chapf-viewpoint-92bee1d292"),
    difficulty: "easy", bestSeason: ["spring", "summer", "autumn"], season: "Snow-free conditions; verify the local path and transport status", durationMinutes: 20,
    startName: "Arvenbüel", finish: "Chapf viewpoint", access: "From Arvenbüel, follow the mostly flat narrow paved road and the final roughly 100 metres of gravel path to the signed viewpoint.",
    parking: "Use only signed public parking in Arvenbüel; capacity and charges should be checked locally.", publicTransport: "Use the current bus connection to Amden, Arvenbüel and verify the return timetable.", accessibility: "The official source describes the approach as suitable for pushchairs, with a short final gravel section; it does not make a wheelchair-accessibility claim.", highlights: ["Walensee panorama", "Mürtschenstock and Leistkamm", "Betlis and Linth plain", "Panorama board"], tip: "Benches, a nearby fireplace and a toilet near the end make this a practical short outing; leave the area clean.", safety: ["Keep children back from steep terrain beyond the maintained viewpoint area and use extra care on wet gravel or winter ice.", ...commonSafety], uncertainties: ["The official destination page gives an approximate 20-minute approach but no reliable distance or elevation-gain figure, so those fields remain blank."], parkingAvailable: true, hasPublicTransport: true,
  },
];
